...
const STR = {
  es: {
    ...
    zoomOut: 'Alejar mapa', clearFilters: 'Borrar filtros', noCoordsRow: 'sin ubicación en el mapa', see: 'Ver',
    loadError: 'No se pudieron cargar las propiedades', retry: 'Reintentar', seeAllInList: 'Ver todas en la lista', noCoordsTitle: 'Sin ubicación en el mapa', moreInArea: 'más en esta zona',
  ...
  en: {
    ...
    zoomOut: 'Zoom out', clearFilters: 'Clear filters', noCoordsRow: 'without a map location', see: 'See',
    loadError: "Couldn't load properties", retry: 'Retry', seeAllInList: 'See all in the list', noCoordsTitle: 'No map location', moreInArea: 'more in this area',
