...
const STR = {
  es: {
    ...
    addPhotos: 'Agregar fotos', photosHint: 'Subí al menos 1 foto (recomendado 4+). La primera es la principal.',
    publishBtn: 'Publicar propiedad', done: '¡Listo!', publishedOk: 'Tu propiedad fue publicada.',
  ...
  en: {
    ...
    addPhotos: 'Add photos', photosHint: 'Upload at least 1 photo (4+ recommended). The first is the cover.',
    publishBtn: 'Publish property', done: 'Done!', publishedOk: 'Your property has been published.',
